      ...
      <section className="px-6 pb-16 md:pb-24" aria-labelledby="custom-bundle-title">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden rounded-lg bg-background border border-gold/10">
            ...
            {/* Right - Text and CTA */}
            <div className="flex flex-col justify-center items-center md:items-start px-8 py-12 sm:px-12 md:px-20 lg:px-24 text-center md:text-left text-white order-1 md:order-2">
              <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.3em] text-gold" style={{ fontFamily: "Montserrat" }}>
                YOUR RITUAL, YOUR WAY
              </p>
              <h2
                id="custom-bundle-title"
                className="text-3xl leading-tight sm:text-4xl md:text-5xl lg:text-6xl text-[#F5F2EC] font-light tracking-wide mb-6"
                style={{ fontFamily: "Cinzel" }}
              >
                MIMI’S EDIT
              </h2>
              <p className="text-sm leading-relaxed text-white/70 max-w-sm mb-8" style={{ fontFamily: "Montserrat", fontWeight: "300" }}>
                Choose the essentials that make you feel most like yourself.
              </p>
              <Link
                href="/build-your-set"
                className="inline-flex border border-gold px-8 py-4 text-[10px] font-bold uppercase tracking-[0.25em] text-gold transition-all duration-300 hover:bg-gold hover:text-background hover:tracking-[0.28em]"

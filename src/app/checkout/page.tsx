              ...
              <form id="checkout-form" onSubmit={handleCheckout} className="space-y-8">
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 p-4 rounded-xl border cursor-pointer transition-colors border-[#D4B483] bg-[#D4B483]/5">
                      <div className="w-4 h-4 rounded-full border flex items-center justify-center border-[#D4B483]">
                        <div className="w-2 h-2 rounded-full bg-[#D4B483]"></div>
                      </div>
                      <span className="text-[#F8F4ED] text-sm">Cash on Delivery</span>
                    </label>
                  </div>
                </section>
              </form>

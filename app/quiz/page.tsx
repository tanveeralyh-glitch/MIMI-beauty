...
const steps = [
  ...
  { q: "How much time will you give the collection?", opts: ["2 min", "5 min", "10 min", "Slow collection"] },
];
      ...
      <AnimatePresence mode="wait">
        {!done ? (
          ...
          <motion.div key="done" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mt-12 text-center">
            ...
            <h2 className="mt-6 font-display text-3xl leading-tight md:text-5xl">Your collection is ready.</h2>
            ...
            <Link href="/shop" className="mt-8 inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-sm text-background">See your collection <ArrowRight className="h-4 w-4" /></Link>
          </motion.div>
        )}
      </AnimatePresence>
    </section>

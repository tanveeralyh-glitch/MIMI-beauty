      ...
      <AnimatePresence mode="wait">
        {!done ? (
          ...
          <motion.div key="done" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mt-12 text-center">
            ...
            <Link href="/shop" className="mt-8 inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-sm text-background">See your ritual <ArrowRight className="h-4 w-4" /></Link>
          </motion.div>
        )}
      </AnimatePresence>
    </section>

...
export default function FaceSerumPage() {
  return (
    <section className="relative isolate min-h-[100svh] overflow-hidden bg-background text-white">
      {/* Background effects */}
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute -left-24 top-1/4 h-[200px] w-[200px] rounded-full opacity-80 md:h-[320px] md:w-[320px]" style={{ background: "#CFA76A14" }} />
        <div className="absolute -right-16 bottom-0 h-[180px] w-[180px] rounded-full md:h-[280px] md:w-[280px]" style={{ background: "#CFA76A10" }} />
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[1400px] flex-col items-center justify-center px-6 py-20 text-center md:px-8 md:py-24 lg:px-12 lg:py-32">
        ...
        <motion.div {...fadeUp(0.1)} className="mb-8">
          <div className="grid h-20 w-20 place-items-center rounded-full border border-gold/40 bg-gold/10 text-gold md:h-24 md:w-24">
            <Droplet className="h-8 w-8 md:h-10 md:w-10" />
          </div>
        </motion.div>
        ...
        >
          We're preparing something special for you. This collection is currently under development and will be available soon.
        </motion.p>
